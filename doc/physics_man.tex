...
\end{equation}
which means that we can solve a simple 2D problem for each beam slice (ideentified by its $\zeta$).
...
\begin{align}
\Delta p_x &= \frac{\Delta P_x} {P_0}= -\frac{qq_0NL (1-\beta_0^2)}{ m_0\gamma_0\beta_0^2 c^2} \,\lambda_0(\zeta)\,\frac{\partial \phi}{\partial x}\left(x, y\right)\label{dpx}\\
\Delta p_y &= \frac{\Delta P_y} {P_0}= -\frac{qq_0NL (1-\beta_0^2)}{ m_0\gamma_0\beta_0^2 c^2} \,\lambda_0(\zeta)\, \frac{\partial \phi}{\partial y}\left(x, y\right)\label{dpy}\\
\Delta \delta \simeq \Delta p_z &= \frac{\Delta P_z} {P_0}= -\frac{qq_0NL (1-\beta_0^2)}{ m_0\gamma_0\beta_0^2 c^2} \,\frac{d\lambda_0}{d\zeta}(\zeta)\,\phi\left(x, y\right)\label{dpz}
\end{align}
