...
[It is probably better to compute the kick in the bunch frame.]
...
\begin{equation}
\frac{\partial \phi}{\partial s} = -\frac{1}{\beta_0 c}\frac{\partial \phi}{\partial t} \label{derder}
\end{equation}
...
=q \left( -\nabla \phi -\frac{\beta_0}{\gamma_0 c}\frac{\partial \phi}{\partial t}\hat{\textbf{i}}_s
 + \beta  \beta_0\nabla \phi 
 + \frac{\beta}{\gamma_0 c} \frac{\partial \phi}{\partial t} \hat{\textbf{i}}_s
  \right)
\end{equation}
...
\begin{equation}
\textbf{F} 
=  -q(1-\beta  \beta_0)\nabla \phi +\frac{(\beta-\beta_0)}{\gamma_0 c}\frac{\partial \phi}{\partial t}\hat{\textbf{i}}_s
\end{equation}
