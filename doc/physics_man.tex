...
\begin{align}
\hat{\rho}_k = \frac{1}{2L}\int_0^{2L} \rho_{2LR}(x)\, e^{j2\pi k \frac{x}{2L}} \, dx \label{eq:rhok}\\
\hat{G}_k = \frac{1}{2L}\int_0^{2L} G_{2LR}(x)\, e^{j2\pi k \frac{x}{2L}} \, dx \label{eq:Gk}
\end{align}
obtaining simply:
\begin{equation}
...
\begin{equation}
\Delta x = \frac{2L}{M} = \frac{L}{N}
\end{equation}

I can approximate the integrals in Eqs.\,\eqref{eq:rhok} and\,\eqref{eq:Gk} as:
\begin{align}
\hat{\rho}_k = \frac{1}{M}\sum_{n=0}^{M-1} \rho_{2LR}(x_n)\, e^{j2\pi  \frac{kn}{M}} \label{eq:rhokfft}\\
\hat{G}_k = \frac{1}{M}\sum_{n=0}^{M-1} G_{2LR}(x_n)\, e^{j2\pi  \frac{kn}{M}}  \label{eq:Gkfft}
\end{align}
