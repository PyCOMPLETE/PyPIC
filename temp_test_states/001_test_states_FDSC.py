...
pic_singlegrid = PIC_FDSC.FiniteDifferences_Staircase_SquareGrid(chamb = chamber, Dh = Dh_single)
...
pl.ticklabel_format(style='sci', scilimits=(0,0),axis='y')  
pl.legend(loc = 'best')
pl.suptitle('Test states for FiniteDifferences_Staircase_SquareGrid')
pl.grid('on')
pl.show()
