...
class Interpolated_Bassetti_Erskine(PyPIC_Scatter_Gather):
    #@profile
    def __init__(self, x_aper, y_aper, Dh=None, sigmax=None, sigmay=None,
            n_imag_ellip=0, tot_charge=1., verbose=True,
            allow_scatter_and_solve=False, dx=None, dy=None):
        # dx and dy added ad-hoc in the spirit of FFT_OpenBoundary
        ...
        if dx!=None and dy!=None:
            assert(Dh==None)
            if self.verbose:
                print 'Bassetti-Erskine, Rectangular Grid'
        ...
        super(Interpolated_Bassetti_Erskine, self).__init__(
            x_aper, y_aper, dx, dy, verbose=self.verbose)
